# Eagle-X-Gen-AIアプリの活用-Dify-ChatBotとRAG

## 概要
Gen AIアプリの活用についてに関するメモ。Pain points、Solution、Difyとは、Difyでやりたいこと、Schedule、システム構成について記録されています。
...
## 次アクション
- [ ] 関連ノートにリンク（[[Eagle X]]、[[Gen AIアプリの活用]]、[[Dify]]など）
- [ ] 必要に応じてMemory Noteに変換

#gen-ai #dify`n#memory #work/one #work/one/eagle-x #work/one/dx