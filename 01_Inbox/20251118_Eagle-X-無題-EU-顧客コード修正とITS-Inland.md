# Eagle-X-無題-EU-顧客コード修正とITS-Inland

## 概要
Eagle X 無題（EU関連）に関するメモ。顧客のコード修正、TTのマッピング、複数シートのチェックシート、Pricerへのメール転送、Opusコードが存在しないPort、大きいTender、Route portfolio sumilationとPricingのAccount、新ITS、Refer、ITSのTransit timeとCo2 emmision、City nameとZip code、Verge1/Rail2/Truck３、ロールアウト完了、デジタルマーケ、SNOW、TusharのR&R、Desired Positioning、Prodigy、Camoaing Monitor、E-mailのトライアル、Qone Quoteのログインアカウント、Turn time PWC確認、Rate renewal、CoP、イベントデータハブについて記録されています。
...
## 次アクション
- [ ] 関連ノートにリンク（[[Eagle X]]、[[EU]]、[[ITS]]、[[Inland]]など）
- [ ] 必要に応じてMemory Noteに変換

#inbox #one #eagle-x #eu #its #inland
