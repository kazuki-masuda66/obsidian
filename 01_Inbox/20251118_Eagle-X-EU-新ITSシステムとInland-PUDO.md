# Eagle-X-EU-新ITSシステムとInland-PUDO

## 概要
EUに関するメモ。新ITSシステム、顧客コード修正、TTマッピング、複数シート、Pricerへのメール転送、Opusコード、大きいTender、Route portfolio sumilation、Inland、PUDOについて記録されています。
...
## 次アクション
- [ ] 関連ノートにリンク（[[Eagle X]]、[[EU]]、[[新ITSシステム]]など）
- [ ] 必要に応じてMemory Noteに変換

#inbox #one #eagle-x #eu #its
